									...
									<hr>
												<?php if(!empty($votes_url_1)){ ?>
														<?php if($time_to_vote_in_minutes_1 > 0){ ?>
															<a style="width:120px;height:70px;" class="btn-u btn-u-red btn-u-lg"><center>Dispo dans<br />
														...
														<?php } else { ?>
														<a style="width:120px;height:70px;" href="<?php echo $votes_url_1; ?>" class="btn-u btn-u-dark btn-u-lg" id="vote1" target="_blank" onclick="setTimeout(vote111, 1000); setTimeout(vote1111, 15000); setTimeout(vote1, 15000); setTimeout(vote11, 1000)"><center>Voter sur le<br />site 1</center></a>
															<div id="recompense1att">
																<a style="width:120px;height:70px;" class="btn-u btn-u-yellow btn-u-lg">
																	<center>En attente de<br />validation</center>
																</a>
															</div>
															<div id="recompense1">
																<a style="width:120px;height:70px;" href="<?php echo $this->Html->url(['controller' => 'votes', 'action' => 'vote1']); ?>" class="btn-u btn-u-green btn-u-lg">
												...
												<?php if(!empty($votes_url_2)){ ?>
														...
														<?php } else { ?>
														<a style="width:120px;height:70px;" href="<?php echo $votes_url_2; ?>" class="btn-u btn-u-dark btn-u-lg" id="vote2" target="_blank" onclick="setTimeout(vote222, 1000); setTimeout(vote2222, 15000); setTimeout(vote2, 15000); setTimeout(vote22, 1000)"><center>Voter sur le<br />site 2</center></a>
															...
															<div id="recompense2">
																<a style="width:120px;height:70px;" href="<?php echo $this->Html->url(['controller' => 'votes', 'action' => 'vote2']); ?>" class="btn-u btn-u-green btn-u-lg">
																	<center>Confirmer<br />le vote</center>
																</a>
															</div>
														<?php } ?>
												...
												<?php if(!empty($votes_url_3)){ ?>
														...
														<?php } else { ?>
														<a style="width:120px;height:70px;" href="<?php echo $votes_url_3; ?>" class="btn-u btn-u-dark btn-u-lg" id="vote3" target="_blank" onclick="setTimeout(vote333, 1000); setTimeout(vote3333, 15000); setTimeout(vote3, 15000); setTimeout(vote33, 1000)"><center>Voter sur le<br />site 3</center></a>
															...
															<div id="recompense3">
																<a style="width:120px;height:70px;" href="<?php echo $this->Html->url(['controller' => 'votes', 'action' => 'vote3']); ?>" class="btn-u btn-u-green btn-u-lg">
																	<center>Confirmer<br />le vote</center>
																</a>
															</div>
														<?php } ?>
												...
												<?php if(!empty($votes_url_4)){ ?>
														...
														<?php } else { ?>
														<a style="width:120px;height:70px;" href="<?php echo $votes_url_4; ?>" class="btn-u btn-u-dark btn-u-lg" id="vote4" target="_blank" onclick="setTimeout(vote444, 1000); setTimeout(vote4444, 15000); setTimeout(vote4, 15000); setTimeout(vote44, 1000)"><center>Voter sur le<br />site 4</center></a>
															...
															<div id="recompense4">
																<a style="width:120px;height:70px;" href="<?php echo $this->Html->url(['controller' => 'votes', 'action' => 'vote4']); ?>" class="btn-u btn-u-green btn-u-lg">
																	<center>Confirmer<br />le vote</center>
																</a>
															</div>
														<?php } ?>
												...
												<?php if(!empty($votes_url_5)){ ?>
														...
														<?php } else { ?>
														<a style="width:120px;height:70px;" href="<?php echo $votes_url_5; ?>" class="btn-u btn-u-dark btn-u-lg" id="vote5" target="_blank" onclick="setTimeout(vote555, 1000); setTimeout(vote5555, 15000); setTimeout(vote5, 15000); setTimeout(vote55, 1000)"><center>Voter sur le<br />site 5</center></a>
															...
															<div id="recompense5">
																<a style="width:120px;height:70px;" href="<?php echo $this->Html->url(['controller' => 'votes', 'action' => 'vote5']); ?>" class="btn-u btn-u-green btn-u-lg">
																	<center>Confirmer<br />le vote</center>
																</a>
															</div>
														<?php } ?>
								...
								<table class="table top-5">
									...
									foreach($data as $d){
										...
										<tr>
											...
											<?php }
											if($nb < $limit){ ?>
											<td><?php echo $this->Html->image($d['User']['avatar'], ['class' => 'avatar-rounded', 'height' => 30, 'width' => 30]); ?> 
												<b>&nbsp;<?php echo $d['User']['username']; ?></b><br></td>
											<?php } else {}
											if($nb < $limit){ ?>
											<td>
