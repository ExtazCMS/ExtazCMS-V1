		                ...
		                <?php } else { ?>
			                <header>
			                	<h4>
				                	...
				                	<button type="submit" class="btn btn-default btn-sm">
			                			<i class="fa fa-paypal"> Acheter</i> <?php echo $paypal_tokens.' '.$site_money; ?> via PayPal pour <?php echo $paypal_price.' '.$site_currency; ?>
			                		</button>
		                	...
		                	<section>
								...
								if($use_starpass != 0) {
									...
									if ($starpass_idd != 0 && $starpass_idp != 0) {
										...
										<iframe	src="http://script.starpass.fr/iframe/kit_default.php?idd=<?php echo $starpass_idd; ?>&amp;background=fff&amp;verif_en_php=1"
											width="660" height="520" frameborder="0"></iframe>
										<?php
									} else {
										?>
